...
| 产品 | 版本 | 安装包 | 说明 |
|------|------|--------|------|
| **知聊** | 5.2.0 | [ZhiLiao-5.2.0-Setup.exe](https://github.com/NewbieCheng/ZhiXiao-ZhiLiao/releases/download/preview/ZhiLiao-5.2.0-Setup.exe) | 微信 4.0+ 本地读库、导出、SOP、HTTP API |
| **知销** | 2.0preview | [PrivateKings-2.0.1preview-win-x64.exe](https://github.com/NewbieCheng/ZhiXiao-ZhiLiao/releases/download/preview/PrivateKings-2.0.1preview-win-x64.exe) | AI 回复建议、知识库、记忆、微信自动化 |
