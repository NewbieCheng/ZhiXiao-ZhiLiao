...
| 产品 | 版本 | 安装包 | 说明 |
|------|------|--------|------|
| **知聊** | 5.2.2 | [ZhiLiao-5.2.2-Setup.exe](https://github.com/NewbieCheng/ZhiXiao-ZhiLiao/releases/download/bug-fix2/ZhiLiao-5.2.2-Setup.exe) | 微信 4.0+ 本地读库、导出、SOP、HTTP API |
| **知销** | 2.1.0preview | [PrivateKings-2.1.0preview-win-x64.exe](https://github.com/NewbieCheng/ZhiXiao-ZhiLiao/releases/download/bug-fix2/PrivateKings-2.1.0preview-win-x64.exe) | AI 回复建议、知识库、记忆、微信自动化 |
