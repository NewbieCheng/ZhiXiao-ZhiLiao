...
| 产品 | 版本 | 安装包 | 说明 |
|------|------|--------|------|
| **知聊** | 5.2.1 | [ZhiLiao-5.2.1-Setup.exe](https://github.com/NewbieCheng/ZhiXiao-ZhiLiao/releases/download/bug-fix/ZhiLiao-5.2.1-Setup.exe) | 微信 4.0+ 本地读库、导出、SOP、HTTP API |
