...
| **知销** | 2.0preview | [PrivateKings-2.0preview-win-x64.exe](https://github.com/NewbieCheng/ZhiXiao-ZhiLiao/releases/download/preview/PrivateKings-2.0preview-win-x64.exe) | AI 回复建议、知识库、记忆、微信自动化 |
