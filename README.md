...
| **知销** | 2.3.0 | [PrivateKings-2.3.0-win-x64.exe](https://github.com/NewbieCheng/ZhiXiao-ZhiLiao/releases/download/Stable/PrivateKings-2.3.0-win-x64.exe) | AI 回复建议、知识库、记忆、微信自动化 |
